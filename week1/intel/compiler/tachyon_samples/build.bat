...
call scripts\buildcilk.bat clean
...
if ""%1"" == ""buildcilk"" goto buildcilk
if ""%1"" == ""buildtbb"" goto buildtbb
if ""%1"" == ""buildopenmp"" goto buildopenmp

if ""%1"" == ""cilk_solution"" goto cilk_solution
...
:cilk_solution
call scripts\buildlib.bat
call scripts\buildcilk.bat solution
exit /b
